...
const resources = [
    ...
    },
    {
        ...
        title: "Epieos",
        type: "tool",
        description: "Reveals social profiles and reviews from email.",
        url: "https://epieos.com/",
        tags: ["osint", "email", "web", "research"],
        keywords: "osint tool for emails and web",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        title: "Holehe",
        type: "tool",
        description: "Checks if email exists on major websites.",
        url: "https://github.com/megadose/holehe",
        tags: ["osint", "email", "web", "github", "research"],
        keywords: "osint githubtool for emails and web",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        title: "h8mail",
        type: "tool",
        description: "Deep reconnaissance via breach data extracts passwords.",
        url: "https://github.com/khast3x/h8mail",
        tags: ["osint", "breach", "web", "passwords"],
        keywords: "Deep recon osint passwords",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        title: "GHunt",
        type: "tool",
        description: "Finds info from Gmail like Drive YouTube photos.",
        url: "https://github.com/mxrch/GHunt/blob/master/README.md",
        tags: ["osint", "email", "web", "research"],
        keywords: "osint tool for emails and web",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        tags: ["osint", "email", "web", "research"],
        keywords: "Checks email or username availability across platforms",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        title: "Emailrep.io",
        type: "tool",
        description: "Analyzes email reputation and threat indicators .",
    ...
    },
    {
        ...
        title: "Eyecon",
        type: "tool",
        description: "Shows caller ID and social profiles.",
        url: "https://www.eyecon-app.com/",
        tags: ["osint", "calls", "web", "id"],
        keywords: "caller osint id",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        title: "Whocalld",
        type: "tool",
        description: "Checks number reputation for spam or fraud .",
        url: "https://whocalld.com/s",
        tags: ["osint", "calls", "web", "id", "reputation"],
        keywords: "osint tool callers id",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        title: "Sync.ME",
        type: "tool",
        description: "Syncs caller info from social media and blocks spam.",
        url: "https://sync.me/w",
        tags: ["osint", "calls", "web", "id", "reputation"],
        keywords: "osint tool for emails and web",
        contributorName: "@Community",
    ...
    },
    {
        ...
        title: "Whatsmyname",
        type: "tool",
        description: "Checks username across 500+ platforms.",
        url: "https://whatsmyname.me/",
        tags: ["osint", "email", "web", "usernames"],
        keywords: "osint tool for username, emails",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        title: "Lenso.ai",
        type: "tool",
        description: "Reverse face image search across web.",
        url: "https://lenso.ai/en",
        tags: ["osint", "email", "web", "facial", "face"],
        keywords: "facial search",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        title: "Tineye",
        type: "tool",
        description: "Tracks image source edits duplicates.",
        url: "https://tineye.com/",
        tags: ["osint", "email", "facial", "face"],
        keywords: "facila search and rcogninition osint",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        title: "Maigret",
        type: "tool",
        description: "Enhanced Sherlock including bios and images.",
        url: "https://github.com/krishpranav/maigret",
        tags: ["osint", "email", "bio", "images"],
        keywords: "sherlock with bios and images",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        title: "FotoForensics",
        type: "tool",
        description: "Detects image tampering using ELA.",
        url: "https://www.fotoforensics.org/",
        tags: ["osint", "email", "forensics", "photo"],
        keywords: "Photo forensics and recognition",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        title: "ViewExifData",
        type: "tool",
        description: "Drag and drop EXIF metadata viewer.",
        url: "http://www.viewexifdata.com/",
        tags: ["osint", "email", "metadata", "exif"],
        keywords: "osint tool for metadata and exif",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        title: "FOFA",
        type: "tool",
        description: "Massive fingerprint database for ports apps devices.",
        url: "https://en.fofa.info/",
        tags: ["osint", "email", "web", "fingerprinting"],
        keywords: "osint tool for emails and web",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        title: "Zoomeye",
        type: "tool",
        description: "Finds internet services devices CVEs.",
        url: "https://www.zoomeye.ai/",
        tags: ["osint", "cve", "CVE", "research"],
        keywords: "osint tool for CVE",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        type: "tool",
        description: "Searches deep web and leaked data.",
        url: "https://intelx.io/",
        tags: ["osint", "dark", "web", "leaked", "credentials"],
        keywords: "osint tool for dark web leaked credentials",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        title: "DeHashed",
        type: "tool",
        description: "Advanced breach search for email IP user.",
        url: "https://dehashed.com/",
        tags: ["osint", "email", "breach", "email"],
        keywords: "osint tool for emails and web",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        id: 65,
        title: "Hunter.io Breach Directory",
        type: "tool",
        description: "Company emails and breach checking.",
        url: "https://hunter.io/",
        tags: ["osint", "email", "breach", "research"],
        keywords: "osint tool for breach checking",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        type: "tool",
        description: "Monitors malware IPs and darknet leaks.",
        url: "https://otx.alienvault.com/",
        tags: ["osint", "email", "darknet", "malware"],
        keywords: "osint tool for darknet and malware",
        contributorName: "@Community",
        contributorLink: "#"
    },
    {
        ...
        tags: ["osint", "email", "malware", "static"],
        keywords: "osint tool for ,malware analysis",
        contributorName: "@Community",
        contributorLink: "#"
    }
